...
const Login = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-paper-50 dark:bg-ink-800 relative overflow-hidden p-6 transition-colors duration-500">
      ...
      <div className="w-full max-w-[340px] relative z-10">
        ...
        >
          <div className="text-center mb-8 relative z-10">
            ...
            <div className="text-overline opacity-40 uppercase tracking-widest leading-none">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-[2.2rem] -translate-y-1/2 text-ink-300 hover:text-ink-900 dark:text-paper-800 dark:hover:text-paper-50 transition-colors p-1"
              >
          ...
          <div className="mt-8 pt-6 border-t border-paper-100 dark:border-white/5 flex flex-col gap-4 relative z-10">
            <Button
              ...
              color="ink"
              fullWidth
              className="!py-3.5 rounded-2xl !bg-paper-100/50 dark:!bg-white/[0.02] border border-paper-100 dark:border-white/5 group"
              icon={() => (
            ...
            <button
              ...
              className="text-overline opacity-40 hover:opacity-100 hover:text-primary-500 font-black uppercase tracking-widest transition-all"
            >
