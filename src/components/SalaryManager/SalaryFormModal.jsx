          ...
          <GlassCard key={idx} padding="p-4" className="bg-stone-50 dark:bg-stone-900/60 border-stone-200 dark:border-stone-800">
            <div className="flex gap-4 items-center">
              ...
              <button
                ...
                className="p-3 rounded-3xl bg-red-900/20 text-red-400 hover:bg-red-900/40 transition-all active:scale-90 border border-red-500/20"
              >
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="p-3 rounded-3xl bg-red-900/20 text-red-400 hover:bg-red-900/40 transition-all border border-red-500/20"
                >
                  <Trash2 className="w-4 h-4" />
                </button>
              </div>
        ...
        >
          ...
          <div className="mt-6 space-y-4">
            <div className="h-1.5 w-full bg-stone-100 dark:bg-stone-800/50 rounded-full flex overflow-hidden border border-stone-200 dark:border-stone-800">
              ...
              <div className="h-full bg-cyan-500 transition-all duration-700 border-l border-stone-950/50" style={{ width: `${Math.min(livePlan.goalRatio * 100, 100)}%` }} />
              <div className="h-full bg-stone-600 transition-all duration-700 border-l border-stone-950/50" style={{ width: `${Math.max(0, 100 - (livePlan.fixedRatio + livePlan.loanRatio + livePlan.savingsRatio + livePlan.goalRatio) * 100)}%` }} />
            </div>
            <div className="flex flex-wrap justify-center sm:justify-between gap-x-4 gap-y-2 px-1">
              {[
                { label: 'Fixed', color: 'bg-red-500', pct: Math.round(livePlan.fixedRatio * 100) },
                ...
                { label: 'Goal', color: 'bg-cyan-500', pct: Math.round(livePlan.goalRatio * 100) },
                { label: 'Free', color: 'bg-stone-600', pct: Math.round(livePlan.freeRatio * 100) }
              ].map(leg => (
