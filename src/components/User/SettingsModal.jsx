...
const SettingsModal = ({ isOpen, onClose, resultClearMs = 10000 }) => {
  ...
  return (
    <>
        ...
        <div className="space-y-5">
          ...
          <section>
            ...
            <button
              ...
              className="w-full flex items-center justify-between p-2.5 rounded-xl bg-red-500/5 border border-red-500/10 hover:bg-red-500/10 transition-all group mt-2 shadow-sm"
            >
              <div className="text-left">
                <p className="text-label font-bold text-red-400 uppercase tracking-tighter">Purge Protocol</p>
              </div>
      ...
      >
        <div className="space-y-6">
          <GlassCard variant="flat" padding="p-4" className="bg-red-500/5 border-red-500/10">
            <div className="flex items-start gap-4">
              <IconBox icon={AlertCircle} size="sm" variant="glass" color="error" className="shrink-0 mt-0.5" />
              <div>
                <p className="text-overline text-red-400 mb-2 uppercase">High-Risk Operation</p>
                <p className="text-label text-red-500/60 leading-relaxed">
